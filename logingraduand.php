...
$username = $_POST['graduandId'];
$password = md5($_POST['GraduandPass']);

$sql = "SELECT * FROM graduand WHERE graduand_id = ? AND password = ?";
...
// 	$sql = "UPDATE graduand SET password = ? WHERE id = $userid"
