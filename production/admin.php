 			...
 			<div class="top_nav">
 				<div class="nav_menu">
 					<nav>
 						...
 						<ul class="nav navbar-nav navbar-right .background-danger">
 							<li class="">
 						...
 						<div class="col-md-12 col-sm-12 col-xs-12">
 							<div class="x_panel">
 												...
 												<div class="modal-dialog modal-lg">
 													<div class="modal-content">
 														...
 														<div class="modal-header">
 															...
 															<h3>List of Graduands in the Faculty of Education</h3>
 														</div>
 														<!-- modal body -->
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										<div class="x_title">
 											<h2>Faculty of Sciences And Applied Technoogy</h2>
 											<div class="clearfix"></div>
 										</div>
 										<div class="x_content">
 											<div class="row">
 											...
 											<div class="modal fade" id="modal-FOS">
 												<div class="modal-dialog modal-lg">
 													<div class="modal-content">
 														...
 														<div class="modal-header">
 															<button type="button" class="close" data-dismiss="modal">&times;</button>
 															<h3>List of Graduands in Faculty of Sciences and Applied Technology</h3>
 														</div>
 														<!-- modal body -->
 														<div class="modal-body">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										<div class="x_title">
 											<h2>Faculty of Humanities and </br> Development Studies</h2>
 											<div class="clearfix"></div>
 										</div>
 										<div class="x_content">
 											<div class="row">
 												...
 												<div class="modal fade" id="modal-FASS">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															...
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduands in Faculty of Humanities and Applied Technology</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										<div class="x_title">
 											<h4>Faculty of Business annd Economics</h4>
 											<div class="clearfix"></div>
 										</div>
 										<div class="x_content">
 											<p>Total Number of Graduands: 								
 												...
 												<div class="modal fade" id="modal-FOA">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															...
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduand in Faculty of Business and Economics</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										<div class="x_title">
 											<h2>Faculty of TVET Institute</h2>
 											<div class="clearfix"></div>
 										</div>
 										<div class="x_content">
 											<p>Total Number of Graduands: 								
 												...
 												<div class="modal fade" id="modal-FET">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															...
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduands in Faculty of TVET Institute</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
