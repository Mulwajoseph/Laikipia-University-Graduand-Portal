...
<head>
	...
	<title>Laikipia University Graduands Portal</title>
	<style>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modal-dept" style="margin-top: 6px;">Sign in </button>
								...
								<div class="tab-content">
									...
									<div id="home" class="tab-pane fade in active">
										...
										<form method="post">
											<div class="form-group">
												<input type="text" class="form-control" name="deptName" placeholder="Staff Post">
											</div>
											<div class="form-group">
												<input type="password" class="form-control" name="deptPass" placeholder="Password">
											</div>
											<div class="form-group">
												<button class="btn btn-block btn-primary signin-button-department">Sign in</button>
									...
									<div id="menu1" class="tab-pane fade">
										...
										<form method="post">
											...
											<div class="form-group">
												<button class="btn btn-block btn-primary signin-button-admin">Sign in</button>
												<button class="btn btn-block btn-danger signin-button">Cancel</button>
											</div>
										</form>
									</div>
									...
									<div id="menu2" class="tab-pane fade">
										...
										<form method="post">
											...
											<div class="form-group">
												<button class="btn btn-block btn-primary signin-button-graduand">Sign in</button>
												<button class="btn btn-block btn-danger signin-button">Cancel</button>
											</div>
										</form>
									</div>
